...
var d = class extends e {
  ...
  _play() {
    ...
    (e3 >= this.duration || e3 < 0) && (e3 = 0, this.playedDuration = 0), this.bufferNode.start(this.audioContext.currentTime, e3), this.playStartTime = this.audioContext.currentTime, this.bufferNode.onended = () => {
...
var u = class _u extends a {
  ...
  loadAudio(e3, s2, n3, r3) {
    return t(this, void 0, void 0, function* () {
      var t3;
      if (this.emit("load", e3), !this.options.media && this.isPlaying() && this.pause(), this.decodedData = null, this.stopAtPosition = null, !s2 && !n3) {
